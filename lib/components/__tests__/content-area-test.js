...
describe('ContentArea', () => {
  it('adds an external link indicator to external links', () => {
    ...
    // as expected though.
    expect(wrapper.text('.external-link-indicator__wrapper')).toMatch(/external link/)
  })
  ...
  it('does not add an external link indicator to internal links', () => {
    ...
    expect(wrapper.text('.external-link-indicator__wrapper')).not.toMatch(/external link/)
  })
})
