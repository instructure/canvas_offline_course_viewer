...
import { Button, Link } from 'instructure-ui'
...
export default class TreeItem extends React.Component {
  ...
  handleFocus (e) {
    e.stopPropagation()
    this.props.onNewFocusedFolder(this.props.structure)
  }

  handleButtonClick (e) {
    e.stopPropagation()
    this.props.onButtonClick(this.props.structure)
  }

  handleItemClick (e) {
    e.stopPropagation()
    this.props.onItemClick(this.props.structure)
  }
...
TreeItem.propTypes = {
  ...
  onNewFocusedFolder: PropTypes.func.isRequired, // (path)
